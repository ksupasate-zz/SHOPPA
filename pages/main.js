    ...
    <main className={styles.main}>
      ...
      <div>
        ...
        <div>
          ...
          >
            <Meta
              title="Air Jordan 1 Retro High OG Sail"
              description="5800 ฿"
            />
          </Card>
        </div>
        ...
        <div>
          <div className={styles.our}>
            <a href="#">
              <img src="https://i.pinimg.com/736x/2c/a0/2a/2ca02a6531b013f104bafa55061882b4.jpg"></img>
            </a>
          ...
          <div className={styles.cate}>
            <a href="/Shoes">
              <img src="https://cf.shopee.co.th/file/a4d6f08393112649b3d2627c14ef1d8c"></img>
            </a>
            <div className={styles.center}>Shoes</div>
          </div>
          <div className={styles.cate}>
            <a href="#">
              <img src="https://cf.shopee.co.th/file/ff3aa71da5e64f48e3b049599cf1f659"></img>
            </a>
            <div className={styles.center}>Apparel</div>
          </div>
          <div className={styles.cate}>
            <a href="#">
              <img src="https://cf.shopee.co.th/file/d0f1760a963499508a61d45fe6c52fda"></img>
            </a>
